...
- I then messed around using scss an html to make the home screen (I did import bootstrap solely to use the grid for now, of course will get to the point of progress where i won't have to do that and will use my own one.) I only started doing this i.e barely finished the heading section but just to try experiment again with scss and get back up to scratch a little.![[table.png]]